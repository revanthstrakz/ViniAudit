...
from ViniAudit.providers.azure.resources.aad.base import AAD
from ViniAudit.providers.azure.resources.rbac.base import RBAC
from ViniAudit.providers.azure.resources.keyvault.base import KeyVaults
from ViniAudit.providers.azure.resources.network.base import Networks
from ViniAudit.providers.azure.resources.securitycenter.base import SecurityCenter
from ViniAudit.providers.azure.resources.sqldatabase.base import Servers
from ViniAudit.providers.azure.resources.storageaccounts.base import StorageAccounts
from ViniAudit.providers.azure.resources.virtualmachines.base import VirtualMachines
from ViniAudit.providers.base.services import BaseServicesConfig
from ViniAudit.providers.azure.resources.appservice.base import AppServices

# Try to import proprietary services
try:
    from ViniAudit.providers.azure.resources.private_appgateway.base import ApplicationGateways
except ImportError:
    pass
try:
    from ViniAudit.providers.azure.resources.private_rediscache.base import RedisCaches
except ImportError:
    pass
try:
    from ViniAudit.providers.azure.resources.private_loadbalancer.base import LoadBalancers
except ImportError:
    pass
