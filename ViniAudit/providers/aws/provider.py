...
from ViniAudit.core.console import print_error, print_exception, print_debug
from ViniAudit.providers.aws.services import AWSServicesConfig
from ViniAudit.providers.aws.resources.vpc.base import put_cidr_name
from ViniAudit.providers.aws.utils import ec2_classic, get_aws_account_id
from ViniAudit.providers.base.configs.browser import combine_paths, get_object_at, get_value_at
from ViniAudit.providers.base.provider import BaseProvider
from ViniAudit.utils import manage_dictionary
from ViniAudit.providers.aws.utils import get_partition_name
