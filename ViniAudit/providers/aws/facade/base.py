...
from ViniAudit.providers.aws.facade.acm import AcmFacade
from ViniAudit.providers.aws.facade.awslambda import LambdaFacade
from ViniAudit.providers.aws.facade.basefacade import AWSBaseFacade
from ViniAudit.providers.aws.facade.cloudformation import CloudFormation
from ViniAudit.providers.aws.facade.cloudtrail import CloudTrailFacade
from ViniAudit.providers.aws.facade.cloudwatch import CloudWatch
from ViniAudit.providers.aws.facade.config import ConfigFacade
from ViniAudit.providers.aws.facade.directconnect import DirectConnectFacade
from ViniAudit.providers.aws.facade.dynamodb import DynamoDBFacade
from ViniAudit.providers.aws.facade.ec2 import EC2Facade
from ViniAudit.providers.aws.facade.efs import EFSFacade
from ViniAudit.providers.aws.facade.elasticache import ElastiCacheFacade
from ViniAudit.providers.aws.facade.elb import ELBFacade
from ViniAudit.providers.aws.facade.elbv2 import ELBv2Facade
from ViniAudit.providers.aws.facade.emr import EMRFacade
from ViniAudit.providers.aws.facade.iam import IAMFacade
from ViniAudit.providers.aws.facade.kms import KMSFacade
from ViniAudit.providers.aws.facade.rds import RDSFacade
from ViniAudit.providers.aws.facade.redshift import RedshiftFacade
from ViniAudit.providers.aws.facade.route53 import Route53Facade
from ViniAudit.providers.aws.facade.s3 import S3Facade
from ViniAudit.providers.aws.facade.ses import SESFacade
from ViniAudit.providers.aws.facade.sns import SNSFacade
from ViniAudit.providers.aws.facade.sqs import SQSFacade
from ViniAudit.providers.aws.facade.secretsmanager import SecretsManagerFacade
from ViniAudit.providers.aws.utils import get_aws_account_id
from ViniAudit.providers.utils import run_concurrently

from ViniAudit.core.conditions import print_error

# Try to import proprietary facades
try:
    from ViniAudit.providers.aws.facade.cognito_private import CognitoFacade
except ImportError:
    pass
try:
    from ViniAudit.providers.aws.facade.docdb_private import DocDBFacade
except ImportError:
    pass
try:
    from ViniAudit.providers.aws.facade.ecs_private import ECSFacade
except ImportError:
    pass
try:
    from ViniAudit.providers.aws.facade.ecr_private import ECRFacade
except ImportError:
    pass
try:
    from ViniAudit.providers.aws.facade.eks_private import EKSFacade
except ImportError:
    pass
try:
    from ViniAudit.providers.aws.facade.guardduty_private import GuardDutyFacade
except ImportError:
    pass
...
class AWSFacade(AWSBaseFacade):
    ...
    async def build_region_list(self, service: str, chosen_regions=None, excluded_regions=None, partition_name='aws'):
        ...
        try:
            ...
            # see https://github.com/revanthstrakz/ViniAudit/issues/548
            ...
            try:
                ...
                # see https://github.com/revanthstrakz/ViniAudit/issues/685
