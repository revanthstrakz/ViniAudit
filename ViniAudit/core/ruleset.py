...
from ViniAudit.core.console import print_debug, print_error, prompt_yes_no, print_exception

from ViniAudit.core.rule import Rule
from ViniAudit.core.rule_definition import RuleDefinition
...
class Ruleset:
    ...
    def find_file(self, filename, filetype='rulesets'):
        ...
        if filename and not os.path.isfile(filename):
            # Not a valid relative / absolute path, check Vini's data under findings/ or filters/
