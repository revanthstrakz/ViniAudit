...
def run_from_cli():
    parser = ViniAuditArgumentParser()
...
def run(provider,
    ...
    """
    Run a Vini job in an async event loop.
    """
...
async def _run(provider,
    ...
    print_info('Launching Vini Audit')
    ...
    try:
        ...
        report = ViniReport(cloud_provider.provider_code,
                             report_name,
                             report_dir,
                             timestamp,
